...
Write a program that takes as input limit from a user. Program should print prime condition using RECURSIVE method.
Program will output if the number is prime "Number is prime number". Otherwise, "Number is not prime number." to the screen.
